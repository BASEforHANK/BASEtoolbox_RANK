...
@label @latex_label @prior @flattenable @with_kw struct ModelParameters{T}
	...
	β::T = 0.99625 		| "beta" 		| L"\beta" 		|  Beta(beta_pars(0.99625, 0.001^2)...)  	| false # discount factor
	...
	τ_lev::T  = 0.75 	| "tau_lev" 	| L"\tau^L" 	|  _  										| false # steady-state income tax rate level
    ...
    BhhBAR::T = 2.8625  | "BhhBAR" |  L"BhhBAR"  |  _  | false
...
@with_kw struct EstimationSettings
	...
	mode_start_file::String 				= "7_Saves/RANK_chain.jld2"#"7_Saves/HANK_mode.jld2" #"7_Saves/parameter_example.jld2" 

	data_file::String 						= "bbl_data_inequality.csv"
	save_mode_file::String 					= "7_Saves/RANK_mode.jld2"
	save_posterior_file::String 			= "7_Saves/RANK_chain.jld2"

	estimate_model::Bool 					= true

	max_iter_mode::Int 						= 20000 
